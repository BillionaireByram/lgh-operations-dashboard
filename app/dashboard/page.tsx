  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-5">
        ...
        <PageSection label="Scoreboard" title="Sales team and AI setting">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div className="lgh-panel rounded-lg p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-white/56">Focus on people who watched, clicked, booked, or need a fast follow-up.</p>
          </div>
          <div className="lgh-panel rounded-lg p-5">
